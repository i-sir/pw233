 ...
 *     "test_environment"        =>"http://pw233.ikun:9090/api/wxapp/play_package/index",
 *     "official_environment"    =>"http://pw233.wxselling.com/api/wxapp/play_package/index",
 * )
 */
...
class PlayPackageController extends AuthController
{
     ...
     * http://pw233.wxselling.com/api/wxapp/play_package/index
     */
     ...
     *
     *
     *   test_environment: http://pw233.ikun:9090/api/wxapp/play_package/find_play_package_list
     *   official_environment: http://pw233.wxselling.com/api/wxapp/play_package/find_play_package_list
     ...
     *
     *
     *   test_environment: http://pw233.ikun:9090/api/wxapp/play_package/find_play_package_index
     *   official_environment: http://pw233.wxselling.com/api/wxapp/play_package/find_play_package_index
    ...
    public function find_play_package_index()
    {
        ...
        $map5                    = [];
        $map5[]                  = ['tag5', '=', 1];
        $result[]                = ['name' => '对赌单', 'key' => 'tag5', 'list' => $PlayPackageInit->get_list(array_merge($where, $map5), $params)];
        $map                     = [];
        $map[]                   = ['tag1', '=', 1];
        $result[]                = ['name' => '累计单', 'key' => 'tag1', 'list' => $PlayPackageInit->get_list(array_merge($where, $map), $params)];
        $map2                    = [];
        $map2[]                  = ['tag2', '=', 1];
        $result[]                = ['name' => '赌红单', 'key' => 'tag2', 'list' => $PlayPackageInit->get_list(array_merge($where, $map2), $params)];
        $map3                    = [];
        $map3[]                  = ['tag3', '=', 1];
        $result[]                = ['name' => '趣味单', 'key' => 'tag3', 'list' => $PlayPackageInit->get_list(array_merge($where, $map3), $params)];
        $map4                    = [];
        $map4[]                  = ['tag4', '=', 1];
     ...
     * )
     *
     *   test_environment: http://pw233.ikun:9090/api/wxapp/play_package/find_play_package
     *   official_environment: http://pw233.wxselling.com/api/wxapp/play_package/find_play_package
